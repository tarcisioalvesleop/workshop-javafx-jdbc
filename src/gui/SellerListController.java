...
public class SellerListController implements Initializable, DataChangeListener{
	...
	private SellerService service;//acloplamento forte
	...
	private void initializeNodes() {
		...
		Utils.formatTableColumnDate(tableColumnBirthDate, "dd/MM/yyyy");//formato da data
		tableColumnBaseSalary.setCellValueFactory(new PropertyValueFactory<>("baseSalary"));
		Utils.formatTableColumnDouble(tableColumnBaseSalary, 2); //formato do salário
	...
	public void updateTableView() {
		...
		//carregando a list dentro do service.SellerService
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.loadAssociatedObjects();//carrega os departments do bd e deixa no controller
